...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver='Shivam', amount=10)
...
def connect_node():
    ...
    response = {'message': 'All the nodes are now connected. The blockchain contains following nodes',
